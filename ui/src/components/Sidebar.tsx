...
export function Sidebar() {
  ...
  // Every labeled section is collapsible (session-scoped) and starts
  // collapsed: the four top items are the primary nav (design constitution);
  // Work/Company sections hold everything else until expanded.
    ...
    <aside className="w-full h-full min-h-0 border-r border-border bg-background flex flex-col">
      ...
      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide flex flex-col gap-4 pointer-coarse:gap-3 px-3 py-2">
        <div className="flex flex-col gap-0.5">
          ...
          <SidebarNavItem to="/brief" label="Brief" icon={Newspaper} badge={inboxBadge.inbox} badgeLabel="unread" />
