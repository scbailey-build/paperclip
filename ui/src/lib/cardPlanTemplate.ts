 ...
 *
 * Deliberately omits Owner / Due Date / Priority / Status: the card's own
 * structured fields are the source of truth for those, and duplicating them
 * in prose would let the two disagree.
 */
